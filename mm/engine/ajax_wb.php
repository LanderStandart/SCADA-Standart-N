...
function getDetail($trn, $ware_id, &$izg, &$country, &$i, &$profiles_count, &$min_price, &$max_price){
  ...
  coalesce(sizg,''),
  coalesce(scountry,''),
  (select p.DESCRIPTION from g\$profiles p where p.id=wb.g\$profile_id) as DESCRIPTION_id
from warebase_g wb
...
//die( $sql);
  ...
  if ($rtn=="") {return "";}
  $rtn=iconv('utf-8','windows-1251', "<table class=\"table \" ><tr> 
    <th>Профиль</th>
...
//	  $s="<tr><td><a href=\"#\" onClick=\"showHide(id_$num); return false;\">++</a></td><td>".$s1."</td></tr><tr id=\"id_$num\" style=\"display: none;\"><td></td><td>".$s."</td></tr>";
	  $s="<tr><td><a href=\"#\" onClick=\"showHide(id_$num); return false;\"><img src='./images/open.png' width=15rem></a></td><td onClick=\"showHide(id_$num); return false;\">".$s1."</td></tr><tr id=\"id_$num\" style=\"display: none;\"><td></td><td>".$s."</td></tr>";
